  ...
  try {
    ...
    const kontribusi = await prisma.kontribusiSoal.create({
      data: {
        ...
        jawaban_benar: body.jawaban_benar || null,
        skor_a: body.skor_a ? parseInt(body.skor_a) : null,
        skor_b: body.skor_b ? parseInt(body.skor_b) : null,
        skor_c: body.skor_c ? parseInt(body.skor_c) : null,
        skor_d: body.skor_d ? parseInt(body.skor_d) : null,
        skor_e: body.skor_e ? parseInt(body.skor_e) : null,
      ...
      const result = await prisma.$transaction(async (tx) => {
        const soalBaru = await tx.soal.create({
          data: {
            ...
            skor_a: kontribusi.skor_a,
            skor_b: kontribusi.skor_b,
            skor_c: kontribusi.skor_c,
            skor_d: kontribusi.skor_d,
            skor_e: kontribusi.skor_e,
